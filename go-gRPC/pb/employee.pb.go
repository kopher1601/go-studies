...
const (
	// enum のタグ番号 0　は UNKNOWN にするのが慣例
...
type Employee struct {
	...
	PhoneNumber []string                    `protobuf:"bytes,5,rep,name=phone_number,json=phoneNumber,proto3" json:"phone_number,omitempty"`                                                  // array ?
	Projects    map[string]*Company_Project `protobuf:"bytes,6,rep,name=projects,proto3" json:"projects,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // map, mapには repeatedを付けるのはできない
...
const file_proto_employee_proto_rawDesc = "" +
	"\n" +
	"\x14proto/employee.proto\x12\bemployee\x1a\x10proto/date.proto\"\xa5\x03\n" +
	"\bEmployee\x12\x0e\n" +
